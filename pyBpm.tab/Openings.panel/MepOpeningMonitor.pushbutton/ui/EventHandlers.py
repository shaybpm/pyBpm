...
def show_intersect_3d_cb(uiapp):
    ...
    t_group = TransactionGroup(doc, "pyBpm | Show Intersected 3D")
    t_group.Start()
    ...
    zoom_increment = 1.6
    zoom_viewCorner1 = bbox_section_box.Min.Add(
...
show_intersect_3d_event = get_simple_external_event(show_intersect_3d_cb)
