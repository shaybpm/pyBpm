...
def run(doc):
    ...
    if load_family_rec_result:
        output.print_html('<div style="color:green">Loaded family: ' + family_rec_filename + '</div>')
    if load_family_round_result:
        output.print_html('<div style="color:green">Loaded family: ' + family_round_filename + '</div>')
